  ...
  methods: {
    remoteMethod (query) {
      if (query !== '') {
        ...
        setTimeout(() => {
            this.loading = false;
            this.statusss = this.statuss.filter(item => {
    ...
    remoteMethods (query) {
      if (query !== '') {
        ...
        setTimeout(() => {
            this.loading = false;
            this.statuss1 = this.statuss.filter(item => {
              return item.name.toLowerCase()
                .indexOf(query.toLowerCase()) > -1;
            });
          }, 200)
    ...
    sendout (newadded) {
      if (this.valueid === 0) {
        ...
        console.log(this.userName1, this.userName2)
